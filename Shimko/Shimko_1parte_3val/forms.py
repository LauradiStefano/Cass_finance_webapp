...
class ComputeForm(wtf.Form):
    ...
    price = wtf.FloatField(label='Spot Price', default=387, validators=[wtf.validators.InputRequired()])
    ...
    time = wtf.FloatField(label='Time to expiration', default=0.1666, validators=[wtf.validators.InputRequired()])
