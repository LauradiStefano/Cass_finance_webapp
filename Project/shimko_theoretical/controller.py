...
def controller_shimko_theoretical(user, request):
    ...
    return {'form': form, 'a0': a0, 'a1': a1, 'a2': a2, 'area_prices': area_prices, 'expected_price': expected_price,
            'sigma2_price': sigma2_price, 'skewness_prices': skewness_prices, 'kurtosis_prices': kurtosis_prices,
