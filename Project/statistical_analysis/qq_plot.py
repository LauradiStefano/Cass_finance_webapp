...
def qq_plot(log_returns):
    ...
    hover_normal = HoverTool(attachment="above", names=['Normal Distr'],
                             tooltips=[("teoretical quantiles", "@teoretical_quantiles"),
    ...
    fig.circle(x='teoretical_quantiles', y='empirical_distr', source=data, color="#0095B6",
               legend='Empirical Distribution',
               size=6, name='Normal Distribution')

    fig.line(x='teoretical_quantiles', y='normal_distr', source=data, color="#D21F1B", legend='Normal Distribution',
