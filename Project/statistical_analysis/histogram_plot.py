...
def histogram_distribution(log_returns):
    ...
    fig.line(x='log_returns', y='norm_pdf', source=data_theoretical, color="#D21F1B", legend='Log returns PDF', line_width=1, alpha=1, name='Theoretical Distribution')
