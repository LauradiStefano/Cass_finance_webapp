        ...
        if form.validate():
            simulated_paths, moments, quantiles, timestep = \
                get_simulated_path_and_moments(form.time.data, form.number_step.data, form.number_paths.data,
                                               ...
                                               form.mu_ewma.data, form.volatility_t0_ewma.data,
                                               form.alpha_ewma.data, form.beta_ewma.data, form.mu_garch.data,
                                               form.volatility_t0_garch.data, form.omega_garch.data,
                                               form.alpha_garch.data, form.beta_garch.data, form.asymm_garch.data,
                                               form.mu_gbm.data, form.sigma_gbm.data, form.mu_heston.data,
                                               form.volatility_t0_heston.data, form.alpha_heston.data,
                                               form.beta_heston.data, form.eta_heston.data, form.rho_heston.data,
                                               form.mu_mjd.data, form.sigma_mjd.data, form.lam_mjd.data,
                                               form.mu_x_mjd.data, form.sigma_x_mjd.data, form.mu_mrg.data,
                                               form.alpha_mrg.data, form.sigma_mrg.data, form.theta_vg.data,
                                               form.sigma_vg.data, form.kappa_vg.data, form.price_abm.data,
                                               form.price_cir.data, form.price_dejd.data, form.price_ewma.data,
                                               form.price_garch.data, form.price_gbm.data, form.price_heston.data,
                                               form.price_mjd.data, form.price_mrg.data, form.price_vg.data)
